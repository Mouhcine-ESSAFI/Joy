...
self.addEventListener('notificationclick', (event) => {
  ...
  // Dismiss action — close only, no navigation
  if (event.action === 'dismiss') return;

  // View action or body click — navigate to the order (or orders list as fallback)
...
console.log('[SW] Service worker loaded — push handlers active');
